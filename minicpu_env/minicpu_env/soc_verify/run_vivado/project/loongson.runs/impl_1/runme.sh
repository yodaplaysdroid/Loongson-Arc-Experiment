...
HD_PWD='C:/Users/oscar/Desktop/minicpu_env/minicpu_env/soc_verify/run_vivado/project/loongson.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log soc_mini_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source soc_mini_top.tcl -notrace
