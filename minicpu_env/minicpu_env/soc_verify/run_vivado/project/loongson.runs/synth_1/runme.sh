...
HD_PWD='C:/Users/oscar/Desktop/minicpu_env/minicpu_env/soc_verify/run_vivado/project/loongson.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log soc_mini_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source soc_mini_top.tcl
