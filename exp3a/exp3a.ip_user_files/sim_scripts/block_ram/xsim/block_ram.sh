...
#
# Script generated by Vivado on Fri Dec 01 10:16:51 +0800 2023
...
#
# Usage        : block_ram.sh
#                block_ram.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                block_ram.sh [-reset_run]
#                block_ram.sh [-reset_log]
#                block_ram.sh [-help]
#
...
# script info
echo -e "block_ram.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./block_ram.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_7 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot block_ram xil_defaultlib.block_ram xil_defaultlib.glbl -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb block_ram.wdb xsim.dir libdpi.so)
...
Usage: block_ram.sh [-step]\n\
Usage: block_ram.sh [-lib_map_path]\n\
Usage: block_ram.sh [-reset_run]\n\
Usage: block_ram.sh [-reset_log]\n\
Usage: block_ram.sh [-keep_index]\n\
