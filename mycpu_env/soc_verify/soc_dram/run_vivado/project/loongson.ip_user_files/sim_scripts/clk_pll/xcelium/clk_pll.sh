...
#
# Script generated by Vivado on Fri Dec 01 09:32:03 +0800 2023
...
#
# Usage        : clk_pll.sh
#                clk_pll.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                clk_pll.sh [-reset_run]
#                clk_pll.sh [-reset_log]
#                clk_pll.sh [-help]
#
...
#                script (type 'clk_pll.sh -help' for more information).
#
...
# script info
echo -e "clk_pll.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./clk_pll.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.clk_pll xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.clk_pll -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log clk_pll_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: clk_pll.sh [-step]\n\
Usage: clk_pll.sh [-lib_map_path]\n\
Usage: clk_pll.sh [-reset_run]\n\
Usage: clk_pll.sh [-reset_log]\n\
Usage: clk_pll.sh [-keep_index]\n\
