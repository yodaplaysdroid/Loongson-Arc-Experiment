...
#
# Script generated by Vivado on Fri Dec 01 09:32:10 +0800 2023
...
#
# Usage        : inst_ram.sh
#                inst_ram.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                inst_ram.sh [-reset_run]
#                inst_ram.sh [-reset_log]
#                inst_ram.sh [-help]
#
...
# script info
echo -e "inst_ram.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./inst_ram.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L dist_mem_gen_v8_0_14 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot inst_ram xil_defaultlib.inst_ram xil_defaultlib.glbl -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb inst_ram.wdb xsim.dir libdpi.so)
...
Usage: inst_ram.sh [-step]\n\
Usage: inst_ram.sh [-lib_map_path]\n\
Usage: inst_ram.sh [-reset_run]\n\
Usage: inst_ram.sh [-reset_log]\n\
Usage: inst_ram.sh [-keep_index]\n\
