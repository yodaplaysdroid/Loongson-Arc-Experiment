...
HD_PWD='C:/Users/oscar/Desktop/exp3b/exp3b.runs/distributed_ram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log distributed_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source distributed_ram.tcl
