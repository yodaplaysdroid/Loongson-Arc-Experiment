...
HD_PWD='C:/Users/oscar/Desktop/exp3b/exp3b.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ram_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ram_top.tcl
